...
try {
  ...
  if (err.name === 'SecurityError') {
    console.log('Unable to get localstorage bullets due to use of file interface and browser privacy settings.');
  } else {
    throw err;
  }
}
  ...
  <React.StrictMode>
    ...
    <div className="container" id="footer">
      <div>If you have feedback, submit
          an <a href="https://github.com/christopherreljin/AF_Bullet_Writer/issues">issue</a> 
          or a <a href="https://github.com/christopherreljin/AF_Bullet_Writer/pulls">pull request</a>.
      </div>
      <div>This site utilizes PDF.JS (pdf import), HandsOnTable (spreadsheet), the DataMuse API (thesaurus), and Bulma (CSS).</div>
      <div>This Folk is maintained by <a href='mailto:christopher.reljin@us.af.mil'>Christopher Reljin</a></div>
    </div>
  </React.StrictMode>
